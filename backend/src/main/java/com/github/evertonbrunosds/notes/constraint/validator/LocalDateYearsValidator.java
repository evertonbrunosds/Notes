package com.github.evertonbrunosds.notes.constraint.validator;

import static com.github.evertonbrunosds.notes.util.LocalDateManager.getYears;

import java.time.LocalDate;

import com.github.evertonbrunosds.notes.constraint.annotation.LocalDateYears;

import jakarta.validation.ConstraintValidator;
import jakarta.validation.ConstraintValidatorContext;

public class LocalDateYearsValidator implements ConstraintValidator<LocalDateYears, LocalDate> {
